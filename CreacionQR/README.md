...
## ¿Qué hace esta app?
Esta carpeta contiene una aplicación **Shiny con navbarPage** orientada a procesos de negocio internos de Racafé. El nombre funcional detectado es **CreacionQR**.
