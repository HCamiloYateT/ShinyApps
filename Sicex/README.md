...
## ¿Qué hace esta app?
Esta carpeta contiene una aplicación **shinydashboard** orientada a procesos de negocio internos de Racafé. El nombre funcional detectado es **Exportaciones de Café**.
